...
use App\Filament\Teacher\Resources\CourseResource\RelationManagers\LessonsRelationManager;
class CourseResource extends Resource
{
    protected static ?string $model = Course::class; //هنا نحدد أن هذا المورد مرتبط بجدول courses في قاعدة البيانات (عن طريق الموديل Course).
